...
export function DestinationFormDialog({
  ...
  return <CreateDestinationDialog open={open} onOpenChange={onOpenChange} />;
}
...
function CreateDestinationDialog({
  ...
  return (
    <FormDialog
      ...
      onOpenChange={onOpenChange}
      title='Điểm đến mới'
      description='Tạo điểm đến du lịch mới trong hệ thống'
      formId='destination-form-dialog'
      isLoading={isPending}
      submitLabel='Tạo mới'
      metaInfo={
        <>
...
function EditDestinationDialog({
  ...
  return (
    <FormDialog
      ...
      description='Cập nhật thông tin điểm đến du lịch'
      formId='destination-form-dialog'
      isLoading={isPending}
...
export function DestinationFormDialogTrigger() {
  const [open, setOpen] = useState(false);
  ...
  return (
    <>
      ...
      <DestinationFormDialog open={open} onOpenChange={setOpen} />
    </>
  );
}
