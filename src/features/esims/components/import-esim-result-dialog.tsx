...
interface ImportEsimResultDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  result: ImportEsimsExcelResponse | null;
}

export function ImportEsimResultDialog({
  open,
  onOpenChange,
  result
}: ImportEsimResultDialogProps) {
      ...
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader>
          <DialogTitle className='flex items-center gap-2'>
            ...
            Import eSIM hoàn tất
          </DialogTitle>
          <DialogDescription>Kết quả import file Excel eSIM</DialogDescription>
        </DialogHeader>
